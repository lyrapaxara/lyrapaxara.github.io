---
title: The disclosure era
lang: en
permalink: /topics/ufos/disclosure-era/
parent: ufos
order: 1
description: From the 2017 New York Times revelation to the 2023 Grusch testimony — a chronology of the institutional shift.
cover: /assets/img/topics/ufos-disclosure-cover.svg
---

<nav class="collection-breadcrumb">
  <a href="/topics/">Topics</a>
  <span class="collection-breadcrumb-sep">›</span>
  <a href="/topics/ufos/">UFOs and UAP</a>
  <span class="collection-breadcrumb-sep">›</span>
  The disclosure era
</nav>
...
- **December 2017** — *The New York Times* reveals the existence of the Pentagon's Advanced Aerospace Threat Identification Program (AATIP), and publishes the now-famous Navy cockpit footage ("Tic-Tac," "Gimbal," "Go Fast").
...
- **US May 8, 2026 release of UFO / UAP declassified material** — [US Department of War](https://www.war.gov/News/Releases/Release/Article/4480582/department-of-war-releases-unidentified-anomalous-phenomena-files-in-historic-t/), [Wikipedia entry on US UAP files](https://en.wikipedia.org/wiki/United_States_UAP_files)
